                ...
                <div className="bg-light border rounded p-3 mb-4" style={{height: "450px", overflowY:"scroll"}}>
                    {
                        allMessages.map(msg => {
                            ...
                            <div className="row justify-content-end pl-5 ">
                                <div className="d-flex flex-column align-items-end m-2 shadow p-2 bg-info border rounded w-auto" style={{ maxWidth: '300px' }}>
                                    <div>
                                        <strong className="m-1 text-uppercase">{msg.name}</strong>
